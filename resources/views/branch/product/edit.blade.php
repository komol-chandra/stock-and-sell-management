...
<div class="row">
    ...
    <div class="card mb-4">
        <h5 class="card-header">Edit {{$product->name}} Product</h5>
        <!-- Account -->

        <div class="card-body">
            <form id="formAccountSettings" method="POST" action="{{route('admin.product.update',$product->id)}}"
                ...
                <div class="row mt-2 mb-2">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <img src="{{$product->image ? asset($product->image):noImg()}}" alt="user-avatar"
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        <select id="is_active" name="is_active" class="select2 form-select">
                            <option value="1" {{$product->is_active==1 ?
                                'selected':''}}>Active</option>
                            <option value="0" {{$product->is_active==0 ?
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <input class="form-control" type="text" id="short_description" name="short_description"
                            value="{{$product->short_description}}" placeholder="enter product short description">
                    </div>

                    <div class="mb-3 col-md-12">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" type="text" id="description" name="description"
                            placeholder="enter product full description">{{$product->description}}</textarea>
                    </div>
